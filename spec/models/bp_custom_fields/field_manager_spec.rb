...
RSpec.describe "FieldManager" do
  ...
  it "updates resources' custom_groups and custom_fields" do
    # adding fields to a group_template attached to a group attached to a resource
    # post = Post.create(title: "Something Oh yeah")
    # post.groups << @field_manager.initialize_group_with_fields(@group_template)
    #
